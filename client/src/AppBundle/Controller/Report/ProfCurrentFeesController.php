...
class ProfCurrentFeesController extends AbstractController
{
     ...
     * @Template("Report/ProfCurrentFees/start.html.twig")
     *
     * @param int $reportId
     *
     * @return array
     ...
     * @Template("Report/ProfCurrentFees/exist.html.twig")
     *
     * @param int $reportId
     */
     ...
     * @Template("Report/ProfCurrentFees/step.html.twig")
     */
...
//                    $request->getSession()->getFlashBag()->add('notice', 'Service fee has been updated');
     ...
     * @Template("Report/ProfCurrentFees/previousEstimates.html.twig")
     *
     * @param int $reportId
     *
     * @return array
     ...
     * @Template("Report/ProfCurrentFees/summary.html.twig")
     *
     * @param int $reportId
     *
     * @return array
